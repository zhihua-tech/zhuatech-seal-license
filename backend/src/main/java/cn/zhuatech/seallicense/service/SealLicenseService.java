...
import cn.zhuatech.seallicense.domain.DomainCatalog;
import cn.zhuatech.seallicense.model.*;
import cn.zhuatech.seallicense.repository.*;
...
import java.util.*;
@Service
public class SealLicenseService {
    ...
    public SealLicenseService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
